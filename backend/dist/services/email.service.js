...
class EmailService {
    ...
    async sendMissionAssignmentEmail(email, employeeName, missionTitle, missionNumber, destination, startDate, endDate) {
    ...
    async sendAssignmentResponseNotification(adminEmail, adminName, employeeName, missionTitle, missionNumber, action, notes) {
        const actionLabels = {
